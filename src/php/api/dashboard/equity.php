<?php
/**
 * Dashboard Equity API
 * Returns total equity breakdown for tenant company
...
try {
    ...
    respond(true, 'Equity loaded', $equity, 200);
} catch (Throwable $e) {
    error_log('Dashboard equity error: ' . $e->getMessage());
