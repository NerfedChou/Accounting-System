...
use Application\Command\Approval\RejectRequestCommand;
 ...
 *
 * @implements HandlerInterface<RejectRequestCommand>
 */
final readonly class RejectRequestHandler implements HandlerInterface
{
    ...
    {
        assert($command instanceof RejectRequestCommand);
        ...
        // Reject with reason (string, not ApprovalReason)
        $approval->reject(
